...
public class MainActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public class Send extends AsyncTask<String,String,String>
    {
        ...
        protected void onPreExecute() {
            ...
            System.out.println("please wait inserting data ");
        }
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                {
                    String query="INSERT INTO test1 (omer) VALUES('"+raw+"')" ;
                    Statement stm=conn.createStatement();
                    stm.executeUpdate(query);
                    msg="inserting  succesfful!!!";
                }
                if (conn != null) {
                    conn.close();
                }
    ...
    public void handleResult(final Result rawResult) {
        ...
        history.setContext(rawResult.getText()+"TEST icinnnnnnnnnnnn");
